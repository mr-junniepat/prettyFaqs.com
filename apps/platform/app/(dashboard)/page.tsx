...
import { CreateOrg } from "@repo/ui/components/ui/createOrg";
import { Badge } from "@repo/ui/components/ui/badge";

import { SearchCheck, Plus, MoreHorizontal } from "lucide-react";
import { Button } from "@repo/ui/components/ui/button";
import { useSearchParams } from "next/navigation";
import { createOrgAction } from "../actions/createOrg";
...
function Home() {
  ...
  const openOnboard = searchParams.get("on");
  ...
  return (
    <>
      ...
      <div className="space-y-4 p-8 pt-6">
        ...
        <p>
          Let's satisfy your customers' curiosity faster and better together!
        </p>
